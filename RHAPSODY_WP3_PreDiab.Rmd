...
params:
  ...
  message: FALSE
  debug: FALSE
title: "RHAPSODY WP3 Pre-Diabetes Analysis Plan (Version 1.2.18)"
...
```{r logo, eval = file.exists("./utils/RHAPSODY_Logo_WEB_Color.png")}
htmltools::img(
  src = "./utils/RHAPSODY_Logo_WEB_Color.png", 
  alt = "logo", 
