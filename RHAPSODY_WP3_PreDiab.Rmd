...
params:
  ...
  message: FALSE
  debug: FALSE
title: "RHAPSODY WP3 Pre-Diabetes Analysis Plan (Version 1.2.25)"
...
if (params$exclude_X) list_files <- list_files[!(grepl("X", basename(list_files)) | grepl("23", basename(list_files)))]
if (params$debug) list_files <- list_files[grepl("21", basename(list_files)) | grepl("22", basename(list_files))]
