...
This will clone (*i.e.*, download) the scripts from two private **Gist** ([main script](https://gist.github.com/mcanouil/15362a96c1561bb51af98760b41c478e) and [utils scripts](https://gist.github.com/f3e2fdc59757fd8577abfe233854580a)) on **GitHub**.  
...
git clone https://gist.github.com/15362a96c1561bb51af98760b41c478e.git ~/WP3/scripts
git clone https://gist.github.com/f3e2fdc59757fd8577abfe233854580a.git ~/WP3/scripts/utils
```
...
```{sh, eval = FALSE}
docker pull umr8199/rhapsody:1.1.0
```
...
In order to retrieve the latest version of the main script `RHAPSODY_WP3_PreDiab.Rmd` and `utils/*` scripts, you can copy/paste the git commands below.  
This will pull (*i.e.*, download) the scripts from two private **Gist** ([main script](https://gist.github.com/mcanouil/15362a96c1561bb51af98760b41c478e) and [utils scripts](https://gist.github.com/f3e2fdc59757fd8577abfe233854580a)) on **GitHub**.  

```{sh, eval = FALSE}
sudo git -C /home/rhapsody/WP3/scripts pull origin master
sudo git -C /home/rhapsody/WP3/scripts/utils pull origin master
```
